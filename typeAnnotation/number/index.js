...
if (typeof simpleNumber === 'number') {
    ...
    console.log('simpleNumber is not a number, simpleNumber is a ' + typeof simpleNumber);
}
console.log('-------------x-------------');
...
if (typeof hexadecimalNumber === 'number') {
    ...
    console.log('hexadecimalNumber is not a number, hexadecimalNumber is a ' +
...
if (typeof octalNumber === 'number') {
    ...
    console.log('octalNumber is not a number, octalNumber is a ' + typeof hexadecimalNumber);
}
console.log('-------------x-------------');
...
if (typeof octalNumber === 'number') {
    ...
    console.log('binaryNumber is not a number, binaryNumber is a ' +
        typeof hexadecimalNumber);
}
console.log('-------------x-------------');
